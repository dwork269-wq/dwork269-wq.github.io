---
title: "Quick Notes on the Reserve Protocol — Governance"
date: 2024-10-20
...
- What proportion of RSR holders actively participate?
- How does it prevent minority capture or disproportionate voting power?
- Could engagement diminish over time, leading to disengaged decision-making?

## Proposal Process

Proposals involve creation, voting, and time locks for security and safeguards.

- Are proposals executed on-chain or managed off-chain?
- What are the trade-offs between these methods in terms of security and accessibility?

## Time Locks

How are urgent proposals handled?

- Do time locks cause delays in critical situations?
- Have delays or exploitation by bad actors occurred due to this mechanism?
...
> [Notes on the Reserve Protocol — Governance](/reserve-protocol-governance) (current) \
> [Notes on the Reserve Protocol — Arbitrage](/reserve-protocol-arbitrage)
