...
- Can USDM **add fiat on/off ramps** to convert **fiat directly into USDM**? It might serve as a good use case for **[cross-border-payments](https://miruvor.me/best-use-case-cross-border-stablecoin-payments)**
...
- Could **[DebtCoin](https://miruvor.me/the-debtcoin-token)** hedge against **U.S. debt servicing risks** in the unlikely case of government defaults?
